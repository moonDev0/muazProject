...
const Privacy = () => {
  return (
    <div className=' px-5 md:px-0 container mx-auto mt-10 md:mt-36 mb-20 text-black leading-9'>

        <section>
            <p className='text-[15px]'>This privacy notice for Pupilbase Ltd ('Company', 'we', 'us', or 'our'), describes how and why we might collect, store, use, and/or share ('process') your information when you use our services ('Services'), such as when you:
            Visit our website at https://www.pupilbase.com, or any website of ours that links to this privacy notice
            Engage with us in other related ways, including any sales, marketing, or events
            Questions or concerns? Reading this privacy notice will help you understand your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at keith@pupilbase.com.</p>
        </section>
    
        <section className='text-[15px]'>
            <h1 className=' mt-3 font-bold'>SUMMARY OF KEY POINTS</h1>
            <p>This summary provides key points from our privacy notice.
            What personal information do we process? When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Pupilbase Ltd and the Services, the choices you make, and the products and features you use.</p>
        ...
        <div className='text-[15px]'>
            <h1 className=' mt-2 font-bold'>TABLE OF CONTENTS</h1>
            <ul className=' '>
                <li>
        ...
        <section className='text-[15px]'>
        <h2 className=' mt-2 font-bold'>1. WHAT INFORMATION DO WE COLLECT?</h2>
        <p>
            Personal information you disclose to us
            <br /> In Short: We collect personal information that you provide to us.
        </p>
        <p>
            We collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services, or otherwise when you contact us. We do not seek to collect sensitive personal information, but this may be disclosed to us during the completion of, for example, surveys.
        </p>
        <p>
    ...
    <section className='text-[15px]'>
        <h2 className=' mt-2 font-bold'>2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
        <p>
    ...
    <section className='text-[15px]'>
        <h2 className=' mt-2 font-bold'>3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
        <p>
    ...
    <section className='text-[15px]'>
        <h2 className=' font-bold mt-2'>4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
        <p>
    ...
    <section className='text-[15px]'>
        <h2 className=' font-bold mt-2'>5. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
        <p>
    ...
    <section>
        <h2 className=' mt-2 font-bold'>6. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
    ...
    <section>
        ...
        <p>
          ...
          <br />  If you are located in Switzerland, the contact details for the data protection authorities are available here <br /> <Link href="https://www.edoeb.admin.ch/edoeb/en/home.html">Click here</Link>.
          ...
          <br />  If you have questions or comments about your privacy rights, you may email us at keith@pupilbase.com.
        </p>
    ...
    <section>
        ...
        <p className='text-[15px]'>
            If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) , Keith Atkins, by email at keith@pupilbase.com, or by post to:
          <br />  Pupilbase Ltd
          <br />  Keith Atkins
          <br />  74b East Street
          <br />  Ilmister, Somerset TA19 0AW
          <br />  United Kingdom

          <h1 className=' font-bold mt-2'>
            12. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?
          </h1>
            You have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: www.pupilbase.com
