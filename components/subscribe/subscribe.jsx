  ...
  return (
    <div>
        <div className=' bg-func-BG bg-no-repeat lg:bg-repeat px-5 md:px-20  container mt-20 mx-auto'>
            <h1 className=' font-sen text-[20px] md:text-[40px] lg:text-[48px] font-extrabold py-10 text-center text-black'>Subscribe to <span className=' text-primary'>Land base</span> today </h1>
